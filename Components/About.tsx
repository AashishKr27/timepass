...
const About = () => {
  return (
    <div id="about" className="bg-[#121121] pb-[3rem] pt-[4rem] md:pb-[8rem] ">
      <div className="grid grid-cols-1 md:grid-cols-2 w-[80%] mx-auto gap-[3rem] items-center">
        ...
        <div data-aos="fade-left" className="lg:w-[500px] mx-auto md:mx-0 mt-[2rem] lg:mt-0 lg:h-[500px] w-[280px] h-[280px] relative">
          <Image
            src={aboutMe}
            priority={true}
            alt="user"
            className="relative rounded z-[11] w-[100%] h-[100%] object-contain"
          />
          <div className="absolute rounded w-[100%] h-[100%] z-[10] bg-[#55e6a5] top-[-2rem] right-[-2rem]"></div>
        </div>
      </div>
    </div>
  );
